...
class CommentReplyCards extends StatefulWidget {
  dynamic snap;
  CommentReplyCards({this.snap, super.key});

  @override
  State<CommentReplyCards> createState() => _CommentReplyCardsState();
}

class _CommentReplyCardsState extends State<CommentReplyCards> {
  bool replyContainer = false;
